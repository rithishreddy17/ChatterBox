      ...
      <div className="container mx-auto space-y-10">
        ...
        <section>
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">Meet New Learning</h2>
                  ...
                  return(
                    <div key={user._id} className="card bg-base-200 hover:shadow-lg transition-all duration-300">
                      <div className="card-body p-5 space-y-4">
                        ...
                        }`} onClick={()=>sendRequestsMutation(user._id)} disabled={hasRequestBeenSent || isPending}>
