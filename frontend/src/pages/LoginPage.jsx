                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="form-control w-full space-y-2">
                      ...
                      <input type="email" placeholder="Rithish@gmail.com" className="input input-bordered w-full" value={loginData.email} onChange={(e)=> setLoginData({...loginData, email: e.target.value})} required/>
                    </div>
          ...
          <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
              <div className="max-w-md p-8">
                ...
                <div className="text-center space-y-3 mt-6">
                  ...
                  <p className="opacity-70">Practice conversations, make friends, and imporove your language skills together</p>
                </div>
              </div>
          </div>
